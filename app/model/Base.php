...
class Base
{
	...
	public function insertData($data, $returnId=false)
	{
		return $returnId ? $this->instance()->insertGetId($data) : $this->instance()->insert($data);
	}
	...
	public function getListData(array $where=[], $field='*', $page=0, $size=0, $order=[], $group='')
	{
