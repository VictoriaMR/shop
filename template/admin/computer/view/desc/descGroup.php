<div class="container-fluid" id="attribute-list">
	<form action="<?php echo adminUrl();?>" class="form-inline">
		<div class="row-item">
			...
			<div class="form-group right">
				<button class="btn btn-success add" type="button"><i class="glyphicon glyphicon-plus"></i> 新增描述分组</button>
			</div>
			<div class="clear"></div>
		</div>
	</form>
	<table class="table table-hover mt10">
		<tbody>
			...
			<tr class="item" data-id="<?php echo $value['descg_id'];?>">
				<td class="col-md-1"><?php echo $value['descg_id'];?></td>
				<td class="col-md-3">
...
<div id="dealbox-language" class="hidden">
	...
	<div class="centerShow">
		<form class="form-horizontal">
			...
			<input type="hidden" name="opn" value="editDescGroupLanguage">
