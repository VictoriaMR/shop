...
const ORDERINDEX = {
	init: function() {
		...
		$('.order-list').on('click', '.repurchase-btn', function(){
			...
			TIPS.confirm(appT('order_repurchase_comfirm'), function(obj){
				TIPS.loadingBtn(obj);
		...
		$('.order-list').on('click', '.delete-btn', function(){
			const id = $(this).parents('.item').data('id');
			TIPS.confirm(appT('order_delete_comfirm'), function(obj){
				TIPS.loadingBtn(obj);
		...
		$('.order-list').on('click', '.refund-btn', function(){
			const id = $(this).parents('.item').data('id');
			TIPS.confirm(appT('order_refund_comfirm'), function(obj){
				TIPS.loadingBtn(obj);
