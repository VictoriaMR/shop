...
<div id="address-page" class="min-page">
	<div class="layer">
		<div class="list-title flex">
			...
			<p class="title"><?php echo distT('address_list');?></p>
			<div class="tcell">
				<p class="line"></p>
			</div>
		</div>
		<div class="address-content mt18">
			...
			<?php }?>
			<?php if (empty($list)) {?>
			<p class="empty-tips"><?php echo distT('address_empty');?></p>
			<?php if (userId()){?>
...
const js_language_text = {
	set_default_confirm: '<?php echo distT('set_default_confirm');?>',
	set_default_bill_confirm: '<?php echo distT('set_default_bill_confirm');?>',
};
</script>
<?php }?>
