...
class AttrRelationService extends Base
{
	...
	public function getListById($skuId, $lanId=1, $simple=false)
	{
		...
		$tempArr = make('app/service/attr/ButeService')->getListById($tempArr, $lanId);
		...
		$tempArr = make('app/service/attr/ValueService')->getListById($tempArr, $lanId);
		$data['attv'] = $attvArr = [];
