<?php $router = router()->getRoute(); if (!(in_array($router['path'], ['checkout', 'product', 'order']) && in_array($router['func'], ['address', 'index'])) && !(in_array($router['path'], ['userInfo']) && in_array($router['func'], ['index']))){ ?>
<div class="p22"></div>
<div id="pb-footbar">
